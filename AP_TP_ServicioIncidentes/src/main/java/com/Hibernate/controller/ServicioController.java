...
public class ServicioController { 
	public String CrearServicio(Integer idTecnico, String tipoServicio , String cuilCliente) {
		...
		try {
			Servicio sevicio = new Servicio(idTecnico, tipoServicio, cuilCliente);
		...
		public void ListadoServicio() {
			...
			try {
						...
						for(Servicio s :servicios) {
							...
							System.out.println("Tipo de servicio: " + s.getTipoServicio()+"\n------------------------------------");
						}
						sessionFactory.close();
